package pl.mikolaj.pokora.pizzaaplicationtest.data.entity.ordersize;

import pl.mikolaj.pokora.pizzaaplicationtest.data.entity.order.OrderEntity;
import pl.mikolaj.pokora.pizzaaplicationtest.data.entity.size.SizeEntity;
